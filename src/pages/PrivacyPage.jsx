     ...
     <Navbar logo={general.logo}/>
      ...
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-md overflow-hidden">
        ...
        <main className="p-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-200 mb-4">Privacy Policy</h2>
            <p className="text-gray-300 leading-relaxed whitespace-pre-line">{general.privacy}</p>
          </section>
        </main>

        <footer className="bg-gray-700 text-center py-4 text-gray-400 text-sm">
          {/* to add a c before 2024 */}
