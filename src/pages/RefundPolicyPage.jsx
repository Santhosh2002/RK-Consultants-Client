     ...
     <Navbar />
      ...
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-md overflow-hidden">
        ...
        <main className="p-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-200 mb-4">Refund Policy</h2>
            {/* <p className="text-gray-300 leading-relaxed whitespace-pre-line">{general.refundPolicy}</p> */}
          </section>
        </main>
